          ...
          <div className="p-8 lg:p-16 flex flex-col justify-center">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-white/80 text-sm mb-2 ml-1">Last Name</label>
                  <Input
                    type="text"
                    placeholder="Doe"
                    required
              ...
              <div>
                <label className="block text-white/80 text-sm mb-2 ml-1">Confirm Password</label>
                <Input
                  type="password"
                  placeholder="••••••••"
                  required
            ...
            <div className="mt-8">
              ...
              <p className="text-center text-white/70 text-sm mt-8">
                ...
                <Link href="/login" className="text-white font-medium underline hover:text-orange-300 transition-colors">
                  Sign in
                </Link>
              </p>
            </div>
          ...
          <div className="hidden lg:block bg-gradient-to-br from-black/80 to-black/60 p-16 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="text-4xl font-bold text-white mb-8 leading-tight">
                Start Your <br /> Fleet Journey Today.
              </h2>
              ...
              <div className="mb-8">
                ...
                <p className="text-white/80 text-lg leading-relaxed mb-6">
                  "We've reduced our operational costs by 30% and improved on-time deliveries significantly since using this system."
                </p>
              </div>

              <div className="mb-8">
                <h3 className="text-white font-semibold text-lg mb-1">Sarah Mitchell</h3>
                <p className="text-white/60">Operations Director at TransGlobal</p>
              </div>
